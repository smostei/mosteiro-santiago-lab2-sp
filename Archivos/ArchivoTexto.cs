...
namespace Archivos
{
    public sealed class ArchivoTexto : IArchivo<String>
    {
        ...
        {
            string directorioYTicket = "TicketsPedidosDelivery/" + "ticket-pedido-" + DateTime.Now.HoraActualFormateada() + ".txt";
            return AppDomain.CurrentDomain.BaseDirectory + directorioYTicket;
        }
    }
